...
public class GoogleLocationService extends Service {
        ...
        if (!mChangingConfiguration && LocationUtilities.requestingLocationUpdates(this)) {
            ...
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.O) {
                mNotificationManager.startServiceInForeground(new Intent(this,
                        GoogleLocationService.class), NOTIFICATION_ID, getNotification());
            } else {
    ...
    private Notification getNotification() {
        ...
        CharSequence text = LocationUtilities.getLocationText(mLocation);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.mipmap.ic_launcher, getString(R.string.loading),
                        activityPendingIntent)
                .addAction(R.drawable.ic_dialog_close_light, getString(R.string.remove_location_updates),
                        servicePendingIntent)
                .setContentText(text)
                .setContentTitle(LocationUtilities.getLocationTitle(this))
                .setOngoing(true)
    ...
    public class LocalBinder extends Binder {
        GoogleLocationService getService() {
